...
/**
 * Calendario
 * Componente pesado con react-big-calendar
 */
export const CalendarioTributario = lazy(
  () =>
    import('@/components/calendario/calendario-principal').then((module) => ({
      default: module.CalendarioPrincipal,
    }))
)

export const ListaProximosEventos = lazy(
  () =>
    import('@/components/calendario/lista-proximos-eventos').then((module) => ({
      default: module.ListaProximosEventos,
    }))
)
