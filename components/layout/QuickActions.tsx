    ...
    <div className="relative w-full max-w-2xl">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder={`Buscar facturas, clientes, documentos... (${shortcutKey})`}
          className="w-full h-11 pl-12 pr-4 rounded-xl border border-gray-200 bg-white text-sm
      ...
      {isSearchFocused && (searchQuery.length >= 2 || searchResults.length > 0) && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl border border-gray-200
                        shadow-xl max-h-96 overflow-y-auto z-50 animate-slideDown">
          {isSearching ? (
            <div className="p-4 text-center">
              <div className="animate-spin inline-block h-6 w-6 border-2 border-primary
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-sm font-medium text-gray-900">Búsqueda global</p>
              <p className="text-xs text-gray-600 mt-1">
      ...
      {!isSearchFocused && !searchQuery && (
        <div className="absolute right-4 top-1/2 -translate-y-1/2 hidden lg:block">
          <kbd className="px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200
                          rounded-md">
            {shortcutKey}
          </kbd>
        </div>
