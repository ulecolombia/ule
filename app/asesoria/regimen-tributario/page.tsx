  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <Alert variant="warning" className="mb-6">
        <AlertDescription>
          <strong>Importante:</strong> Este análisis es de carácter informativo y educativo,
          basado en información general. No constituye asesoría tributaria profesional certificada.
          Para decisiones tributarias específicas, se recomienda consultar con un contador público
          o abogado tributarista que pueda analizar tu caso particular en detalle.
        </AlertDescription>
      </Alert>
      ...
      {reporte && (
        <div className="space-y-6">
          ...
          <Card className="p-8 bg-gradient-to-br from-primary/10 to-primary/5 border-primary">
            <div className="text-center">
              <Badge
                variant={reporte.confianzaRecomendacion === 'ALTA' ? 'default' : 'secondary'}
                className="mb-4"
              >
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Basado en tu perfil actual, este régimen ofrece las mejores condiciones
                tributarias y administrativas para tu situación.
              </p>
            </div>
          </Card>
          ...
          {reporte.consideracionesAdicionales.length > 0 && (
            <Card className="p-6">
              ...
              <ul className="space-y-2">
                {reporte.consideracionesAdicionales.map((consideracion, index) => (
                  <li key={index} className="flex items-start">
          ...
          <Card className="p-6 bg-gray-50 dark:bg-gray-900">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1 text-sm text-gray-600 dark:text-gray-400">
                <p className="font-semibold mb-2">Sobre este análisis:</p>
                <p>
                  Este reporte fue generado el {new Date(reporte.fechaAnalisis).toLocaleDateString('es-CO', {
                    dateStyle: 'long'
                  })} basado en la información de tu perfil y la normativa tributaria colombiana vigente
                  (Ley 2277 de 2022 y normas concordantes). La información tributaria puede cambiar,
                  por lo que recomendamos mantener este análisis actualizado y consultar con un profesional
        ...
        <Card className="p-12 text-center">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Genera un análisis tributario personalizado basado en tu perfil para
              descubrir qué régimen es más conveniente para ti.
            </p>
